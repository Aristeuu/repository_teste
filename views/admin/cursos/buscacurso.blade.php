     ...
     @foreach($listaCursos as $lista)
        ...
        <div class="col-md-4 col-sm-6">
                  <div class="col-item">
                                ...
                                <a href="/detalhes/{{$lista->id}}">   <img src="http://yetoafrica.com/storage/app/public/{{$lista->curso_img}}" style="	max-width: 100%;	width: 360px; height: 260px; object-fit: cover;" alt="a" /></a>
                                </div>
                                <div class="info">
                                    <div class="row">
