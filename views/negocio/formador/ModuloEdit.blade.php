...
<div class="site">
        ...
        <div class="caixa">
			<h2 class="titulo"><span class="case"><i class="ico duvida"></i>Editando Módulo</span></h2>
        </div>

<formulario css="" action="/updateMod/{{$modulos[0]->id}}" method="post" enctype="multipart/form-data" token="{{ csrf_token() }}">  
    {{ csrf_field() }}
    ...
    <div class="col col-md-6">
            ...
            <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Design" id="modulo_titulo" name="modulo_titulo" value="{{$modulos[0]->modulo_titulo}}">
     ...
     <div class="col col-lg-12">
            <div class="form-group"> 
                ...
                <ckeditor name="modulo_descricao"  id="modulo_desci"  v-bind:config="{
                    ...
                    height: 200
                }" value="{{$modulos[0]->modulo_descricao}}">
                </ckeditor>
            </div>
    </div>
</div>
